...
const css = `
  ...
  .studio-root { background:#1c1c1c; min-height:100vh; font-family:'Cormorant Garamond',Georgia,serif; color:#f2ece0; }
  ...
  .studio-title { font-family:'Cinzel',serif; font-size:clamp(1.8rem,4vw,3rem); font-weight:400; color:#f8f2e4; letter-spacing:0.1em; margin:0 0 1rem; }
  .studio-desc { font-size:1.1rem; color:#b8b0a4; max-width:560px; margin:0 auto; line-height:1.8; font-style:italic; }
  ...
  .plan-card { background:#1c1c1c; padding:2.5rem 2rem; transition:background 0.3s; }
  ...
  .plan-name { font-family:'Cinzel',serif; font-size:1rem; color:#f8f2e4; letter-spacing:0.1em; margin-bottom:0.6rem; }
  ...
  .plan-features li { font-size:0.88rem; color:#b8b0a4; line-height:1.6; padding-left:1rem; position:relative; }
  ...
  .mint-preview-empty { width:100%; aspect-ratio:1; background:#242424; border:1px solid rgba(212,175,55,0.1); display:flex; align-items:center; justify-content:center; color:#6a6258; font-family:'Cinzel',serif; font-size:0.6rem; letter-spacing:0.2em; margin-bottom:0.5rem; }
  .mint-input { background:#242424; border:1px solid rgba(212,175,55,0.15); color:#f2ece0; padding:0.65rem 0.85rem; font-family:'Cormorant Garamond',serif; font-size:0.95rem; width:100%; box-sizing:border-box; transition:border-color 0.2s; }
  .mint-input:focus { outline:none; border-color:rgba(212,175,55,0.4); }
  .mint-input::placeholder { color:#6a6258; }
  ...
  .studio-disclaimer { text-align:center; font-size:0.72rem; color:#8a8278; font-family:'Cinzel',serif; letter-spacing:0.1em; max-width:640px; margin:2rem auto 0; padding:0 2rem 3rem; }
      ...
      <div style={{ maxWidth: "820px", margin: "3rem auto 0", padding: "0 1rem" }}>
        {waitlistDone ? (
          <div style={{ border: "1px solid rgba(212,175,55,0.2)", background: "rgba(212,175,55,0.03)", padding: "3rem 2rem", textAlign: "center" }}>
            ...
            <p style={{ fontFamily: "'Cinzel', serif", fontSize: "1.2rem", color: "#f8f2e4", margin: "0 0 0.5rem" }}>{t("studio.waitlist_joined")}</p>
            <p style={{ fontStyle: "italic", color: "#8a8278", fontSize: "0.9rem", margin: 0 }}>{t("studio.waitlist_note")}</p>
          </div>
        ) : (
          <div style={{ border: "1px solid rgba(212,175,55,0.15)", padding: "2.5rem 2rem" }}>
            ...
            <h2 style={{ fontFamily: "'Cinzel', serif", fontWeight: 400, fontSize: "1.3rem", color: "#f8f2e4", letterSpacing: "0.08em", margin: "0 0 1.5rem" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1rem", maxWidth: "480px" }}>
              ...
              <button
                ...
                style={{
                  ...
                  border: "none",
                  color: waitlistForm.email ? "#141414" : "#666",
          ...
          <div style={{ maxWidth: 860, margin: "0 auto 2rem", border: "1px solid rgba(92,184,92,0.2)", background: "rgba(92,184,92,0.03)", padding: "1.25rem 1.5rem" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem" }}>
              <div>
                ...
                <p style={{ fontFamily: "'Cinzel', serif", fontSize: "1rem", color: "#f8f2e4", letterSpacing: "0.08em", margin: "0 0 0.2rem" }}>{activePlan.label}</p>
                {activePlan.priceMonthly !== null
                  ...
                  : <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "0.85rem", color: "#8a8278", fontStyle: "italic", margin: 0 }}>{t("studio.billing_annual")}</p>
                }
              </div>
              <div style={{ display: "flex", gap: "0.75rem", alignItems: "center" }}>
                {confirmCancel ? (
                  ...
                  <button onClick={() => setConfirmCancel(true)} style={{ padding: "0.4rem 1rem", background: "transparent", border: "1px solid rgba(212,175,55,0.15)", color: "#6a6258", fontFamily: "'Cinzel', serif", fontSize: "0.55rem", letterSpacing: "0.12em", cursor: "pointer" }}>{t("studio.btn_cancel_sub")}</button>
                )}
              </div>
            </div>
          </div>
          ...
          {PLANS.map(plan => {
            ...
            return (
              <div key={plan.tier} className={`plan-card${plan.tier === "gallery" ? " featured" : ""}`}>
                ...
                <div style={{ fontFamily: "'Cinzel', serif", fontSize: "0.85rem", color: plan.priceMonthly !== null ? "#d4af37" : "#b8b0a4", letterSpacing: "0.05em", marginBottom: "0.4rem" }}>
                  ...
                  plan.tier === "institutional" ? (
                    <a
                      ...
                      style={{
                        ...
                        color: "#b8b0a4", fontFamily: "'Cinzel', serif", fontSize: "0.55rem",
                    ...
                    <div style={{ marginTop: "1.25rem", display: "flex", flexDirection: "column", gap: "0.4rem" }}>
                      <button
                        ...
                        style={{
                          ...
                          color: plan.tier === "gallery" ? "#141414" : "#b8b0a4",
